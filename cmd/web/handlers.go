...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
  ...
  // If there are any validation errors, then re-display the create.tmpl
  // template, passing in the snippetCreateForm instance as dynamic data in the
  // Form field. Note that we use the HTTP status code 422 Unprocessable Entity
